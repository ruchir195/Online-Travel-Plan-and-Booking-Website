            ...
            <section className='py-20  ' >
                <div className="px-5 py-10 flex items-center justify-center">
                    <div className="lg:w-2/6 md:w-1/2  items-center mr-5 justify-center rounded-lg flex flex-col w-full mt-10 md:mt-0">
                        <img alt="ecommerce" className="w-full object-cover pt-12 pb-3 pl-12 object-center rounded" src="../images/AuthImages/Reset1.png" />
                    </div>
                    <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg py-3 flex flex-col w-full mt-12 md:mt-8  z-10 shadow-md">
                        <div className='py-8 px-14'>
                            ...
                            <form onSubmit={handleSubmit(clickHandler)}>
                                ...
                                <button className="text-white bg-yellow-400 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-500 rounded text-lg">Update Password</button>
                            </form>
                        </div>
                    </div>
                </div>
